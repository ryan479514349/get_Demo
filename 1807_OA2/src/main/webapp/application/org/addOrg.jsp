	...
	<form action="orgController/addOrg" method="post" class="form form-horizontal" id="form-org-add">
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="销售部" placeholder=""  id="orgName" name="orgName" datatype="*3-8" nullmsg="组织名称不能为空" errormsg="名称只能是3~8的字符串">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text"  placeholder="" id="parentName" name="orgParentName" disabled="disabled" datatype="*" nullmsg="父组织不能为空">
				<input type="hidden" name="orgParentId" id="parentId">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<textarea name="orgDesc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">好好学习,天天向上</textarea>
